...
import { BookOpen, FileIcon, FolderIcon } from "lucide-react"
...
export function AgentRepoView({ files, readme }: AgentRepoViewProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* README below the file tree when no file is selected */}
      {!selectedFile && readme && (
        <Card>
          <CardHeader className="flex flex-row items-center gap-2 px-4 py-3">
